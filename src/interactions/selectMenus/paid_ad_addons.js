...
function addonMenu() {
  ...
  return new ActionRowBuilder().addComponents(
    new StringSelectMenuBuilder().setCustomId('paid_ad_addon_choice').setPlaceholder('Choose an add-on...').addOptions(
...
export default {
  ...
  async execute(interaction) {
    ...
    setPaidAdDraft(interaction.user.id, { addonSelection: null });
