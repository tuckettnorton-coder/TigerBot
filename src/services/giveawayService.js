  ...
  try {
    ...
    for (const giveawayRecord of endedGiveaways) {
      try {
        ...
        if (winners.length > 0) {
          const winnerAnnouncement = `🎉 **Congratulations ${winnerMentions} on winning ${giveaway.prize || 'the giveaway'}!**\n\nMake sure to create a **Giveaway Claim Ticket** to claim your money in <#1504949441650622575>.`;
