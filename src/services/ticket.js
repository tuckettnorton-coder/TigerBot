    ...
    if (dmOnClose) {
      try {
        ...
        if (ticketCreator) {
          ...
          // Generate the transcript before the creator's channel permissions are removed,
          // then send the actual HTML transcript file in the same DM as the close notice.
